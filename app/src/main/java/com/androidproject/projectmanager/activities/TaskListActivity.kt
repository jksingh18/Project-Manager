...
import com.androidproject.projectmanager.adapters.TaskListItemsAdapter
import com.androidproject.projectmanager.firebase.FirestoreClass
import com.androidproject.projectmanager.models.Board
import com.androidproject.projectmanager.models.Card
import com.androidproject.projectmanager.models.Task
...
class TaskListActivity : BaseActivity() {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            ...
            R.id.delete_board->
            {
                ...
                builder.setPositiveButton("Yes") { dialogInterface, which ->
                    ...
                    if (this is TaskListActivity) {
                        this.deleteBoard(mBoardDetails)
                    }
                }
            ...
            R.id.report_board->
            {
                val intent = Intent(this@TaskListActivity, ReportActivity::class.java)
                intent.putExtra(Constants.BOARD_DETAIL, mBoardDetails)
